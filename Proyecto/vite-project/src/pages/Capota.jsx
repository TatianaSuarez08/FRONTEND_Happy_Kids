      ...
      <div className="container mt-5">
        ...
        <div className="row g-4">
          ...
          <div className="col-md-4 mb-4">
            <div className="card card-producto h-100 shadow">
              <img
                src="/Imagenes de ropa/Repujuada-Capota (2).jpeg"
                className="card-img-top"
                alt="Diseño Capota"
              />
          ...
          <div className="col-md-4 mb-4">
            <div className="card card-producto h-100 shadow">
              <img
                src="/Imagenes de ropa/Repujuada-Capota (3).jpeg"
                className="card-img-top"
                alt="Diseño Capota"
              />
          ...
          <div className="col-md-4 mb-4">
            <div className="card card-producto h-100 shadow">
              <img
                src="/Imagenes de ropa/Repujuada-Capota (4).jpeg"
                className="card-img-top"
                alt="Diseño Capota"
              />
          ...
          <div className="col-md-4 mb-4">
            <div className="card card-producto h-100 shadow">
              <img
                src="/Imagenes de ropa/Repujuada-Capota (5).jpeg"
                className="card-img-top"
                alt="Diseño Capota"
              />
