...
import "./BermudaLiloYStitch.css";

function BermudaLiloYStitch() {
            ...
            <div className="col-md-4 mb-4" key={item}>
              <div className="card card-producto h-100 shadow">
                ...
                <img
                  src={
                    item === 1
                      ? "/Imagenes de ropa/Bermuda-Lilo-Y-Stitch.jpeg"
                      : `/Imagenes de ropa/Bermuda-Lilo-Y-Stitch (${item}).jpeg`
                  }
...
export default BermudaLiloYStitch;