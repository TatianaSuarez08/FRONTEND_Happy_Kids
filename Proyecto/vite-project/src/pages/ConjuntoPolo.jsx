...
import "./ConjuntoPolo.css";

function ConjuntoPolo() {
       ...
       <div className="row g-4">
          ...
          <div className="col-md-4 mb-4">
            <div className="card shadow h-100">
              ...
              <img
                src="/Imagenes de ropa/Conjunto-Polo (2).jpeg"
                className="card-img-top"
                alt="Diseño Polo"
              />
          ...
          <div className="col-md-4 mb-4">
            <div className="card shadow h-100">
              ...
              <img
                src="/Imagenes de ropa/Conjunto-Polo (3).jpeg"
                className="card-img-top"
                alt="Diseño Polo"
              />
