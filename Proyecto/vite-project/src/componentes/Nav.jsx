    ...
    <>
      ...
      <nav style={{ background: "#1a1a1a", padding: "10px 0", borderBottom: "1px solid #2e2e2e" }}>
        <div className="container d-flex align-items-center gap-3">
          ...
          {/* Logo */}
          <Link to="/Home" style={{ textDecoration: "none", whiteSpace: "nowrap" }}>
          ...
          <div className="d-flex align-items-center gap-2">
            ...
            <button className="btn text-white border-0 p-2 position-relative" onClick={() => navigate("/Favoritos")}>
              ...
              {favoritos.length > 0 && (
                <span className="position-absolute top-0 start-100 translate-middle badge rounded-pill" style={{ background: "#ff8c42", fontSize: "10px" }}>
                  {favoritos.length}
                </span>
              )}
            </button>
            ...
            {/* Carrito */}
            <button className="btn text-white border-0 p-2 position-relative">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                <path d="M6 2L3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4z"/><line x1="3" y1="6" x2="21" y2="6"/><path d="M16 10a4 4 0 0 1-8 0"/>
              </svg>
              <span className="position-absolute top-0 start-100 translate-middle badge rounded-pill" style={{ background: "#ff8c42", fontSize: "10px" }}>2</span>
            </button>
              ...
              {dropdownOpen && (
                <div style={{ position: "absolute", right: 0, top: "calc(100% + 8px)", background: "#1e1e1e", border: "1px solid #2e2e2e", borderRadius: "12px", minWidth: "220px", zIndex: 999, boxShadow: "0 8px 32px rgba(0,0,0,0.4)", overflow: "hidden" }}>
                  <div style={{ padding: "14px 16px", borderBottom: "1px solid #2e2e2e" }}>
                    <div style={{ color: "#fff", fontWeight: 600, fontSize: "14px" }}>Ana López</div>
                    <div style={{ color: "#666", fontSize: "12px" }}>ana@correo.com</div>
                  </div>
                  ...
                  <Link to="/pedidos" onClick={() => setDropdownOpen(false)} style={{ display: "flex", alignItems: "center", gap: "10px", padding: "12px 16px", color: "#ccc", textDecoration: "none", fontSize: "14px" }}>
                  ...
                  <Link to="/direcciones" onClick={() => setDropdownOpen(false)} style={{ display: "flex", alignItems: "center", gap: "10px", padding: "12px 16px", color: "#ccc", textDecoration: "none", fontSize: "14px" }}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"/><circle cx="12" cy="10" r="3"/></svg>
                    Direcciones
                  </Link>
                  <button onClick={cerrarSesion} style={{ display: "flex", alignItems: "center", gap: "10px", padding: "12px 16px", color: "#ccc", background: "none", border: "none", borderTop: "1px solid #2e2e2e", width: "100%", textAlign: "left", fontSize: "14px", cursor: "pointer" }}>
      ...
      <div style={{ background: "#111", borderBottom: "1px solid #2e2e2e", padding: "6px 0" }}>
        <div className="container d-flex align-items-center gap-4">
          <Link to="/Home" style={{ color: "#ccc", textDecoration: "none", fontSize: "13px" }}>Inicio</Link>
          <Link to="/catalogo" style={{ color: "#ccc", textDecoration: "none", fontSize: "13px" }}>Catálogo</Link>
          <Link to="/ofertas" style={{ color: "#ccc", textDecoration: "none", fontSize: "13px" }}>Ofertas</Link>
          <Link to="/vercatalogo" style={{ color: "#ccc", textDecoration: "none", fontSize: "13px" }}>VerCatálogo</Link>
        </div>
      </div>
    </>
  );
